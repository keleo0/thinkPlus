  ...
  const uint32_t    initval)   /* initval */
{
  ...
  u.ptr = key;
  if (__LOL_LITTLE_ENDIAN__ && ((u.i & 0x3) == 0)) {
  ...
  } else if (__LOL_LITTLE_ENDIAN__ && ((u.i & 0x1) == 0)) {
...
#else /* LOL_XXX_ENDIAN == 1 */
#error Must define __LOL_BIG_ENDIAN__ or __LOL_LITTLE_ENDIAN__
#endif /* LOL_XXX_ENDIAN == 1 */
